create database
create table rentingtbl(rentid int identity primary key,carid int,dtfrom datetime,dtto datetime , km float, cost numeric(18,3), idCustomer nvarchar(10), sug int)
declare @i int = 0
while @i < 300
begin
